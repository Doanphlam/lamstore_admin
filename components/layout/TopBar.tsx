...
/* local */
import { navLinks } from "@/lib/constant" /* application */
...
const TopBar = () => {
  ...
  return (
    <div className="sticky top-0 z-20 w-full flex justify-between items-center px-8 py-4 bg-grey-2 shadow-x1 lg:hidden">
